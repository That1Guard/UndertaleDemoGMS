...
if (global.flag[286] == 0)
{
    ...
    global.msg[3] = "* For example:&* Do you know what a&  " + '"' + "smiley" + '"' + " is?/"
...
if (global.flag[286] == 2)
{
    ...
    global.msg[1] = "* I did not mean to write&  " + '"' + "sincerly." + '"' + "&* I meant to say " + '"' + "sincerely." + '"' + "/"
...
{
    global.msg[0] = "* (TORIEL sent you a message.)/"
    global.msg[1] = "* This is Sans^1.&* Frisk^1, did you know that I&  love to " + '"' + "get owned?" + '"' + "/"
...
{
    global.msg[0] = "* (TORIEL sent you a message&  titled " + '"' + "Cat Video." + '"' + ")/"
...
if (global.flag[286] == 12)
{
    ...
    global.msg[2] = "* " + '"' + "Dreemurr" + '"' + " and " + '"' + "Femur.^1" + '"' + "&* L-O-L!/"

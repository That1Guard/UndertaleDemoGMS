for (i = 0; i < 8; i += 1)
{
    ...
    switch itemid
    {
        ...
        case 6:
            ...
            if (global.seriousbattle == 1)
                global.itemnameb[i] = "PmknRings"
            break
        case 7:
            global.itemnameb[i] = "SpidrDont"
            if (global.seriousbattle == 1)
                global.itemnameb[i] = "SpdrDonut"
            break
        case 8:
            global.itemnameb[i] = "StocOnoin"
            if (global.seriousbattle == 1)
                global.itemnameb[i] = "Onion    "
            break
        case 9:
            global.itemnameb[i] = "GhostFrut"
            if (global.seriousbattle == 1)
                global.itemnameb[i] = "GhstFruit"
            break
        case 10:
            global.itemnameb[i] = "SpidrCidr"
            if (global.seriousbattle == 1)
                global.itemnameb[i] = "SpdrCider"
            break
        case 11:
            global.itemnameb[i] = "ButtsPie "
            if (global.seriousbattle == 1)
                global.itemnameb[i] = "Pie      "
            break
        case 12:

...
switch room
{
    ...
    case 81:
        ...
        if (u == 1)
        {
            ...
            global.msg[5] = "THEN TACKLES YOU&AND YELLS&" + '"' + "SNOW-WRESTLING!" + '"' + "/"
    ...
    case 186:
        ...
        if (u == 1)
        {
            ...
            scr_papface(6, 3)
            global.msg[7] = "PARTY " + '"' + "GAMES" + '"' + "^1?&LIKE THE SIX-&LEGGED RACE?/"
            scr_undface(8, 2)
            global.msg[9] = "* Nah^1, like " + '"' + "pillow&  fight the skeleton!" + '"' + "/"
            scr_papface(10, 5)
    ...
    case 168:
        ...
        if (u == 1)
        {
            ...
            global.msg[3] = "\E9* The L stands for&  the color " + '"' + "Lime." + '"' + "/"
            scr_papface(4, 0)
    ...
    case 161:
        ...
        if (u == 1)
        {
            ...
            scr_undface(7, 9)
            global.msg[8] = "\E9* Would you really&  call it " + '"' + "cooking" + '"' + "&  a popsicle...?/"
            scr_papface(9, 5)
    ...
    case 139:
        ...
        scr_sansface(3, 1)
        global.msg[4] = "* the sign outside&  says " + '"' + "lab." + '"' + "/"
        scr_papface(5, 3)
        global.msg[6] = "LAB?/"
        scr_sansface(7, 1)

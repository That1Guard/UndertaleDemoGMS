switch argument0
{
    ...
    case 226:
        ...
        if (global.flag[56] == 1)
        {
            global.msg[0] = "* How am I doing^1?&* By " + '"' + "I" + '"' + " I mean the piece&  of me I gave you.../"
            scr_itemcheck(16)
            scr_storagecheck(16)
            if (haveit == false && haveit2 == 0)
            {
    ...
    case 229:
        ...
        if (global.choice == 1)
        {
            ...
            global.msg[4] = "\E0I JUST FILL ALL&THE BOXES IN WITH&THE LETTER " + '"' + "Z" + '"' + ".../"
    ...
    case 525:
        if (global.choice == 0)
        {
            ...
            global.msg[1] = "* " + '"' + "Why did the skeleton want&  a friend?" + '"' + "/"
            global.msg[2] = "* " + '"' + "Because she was feeling&  BONELY..." + '"' + "/"
    ...
    case 559:
        if instance_exists(obj_papyrusparent)
        {
            ...
            global.msg[4] = '"' + "HANG-OUT" + '"' + " LIKE&A PAIR OF VERY&COOL FRIENDS?/"
            if (global.flag[66] == 1)
    ...
    case 564:
        ...
        break
    case 565:
        global.msg[0] = "* (This mailbox is labelled&  " + '"' + "PAPYRUS" + '"' + ".)/"
    ...
    case 581:
        if (global.flag[84] < 3)
        {
            if (global.choice == 0)
            {
                global.msg[0] = "* Huh^1?&* " + '"' + "SURFACE" + '"' + "^1?&* What do you mean?/"
    ...
    case 601:
        ...
        break
    case 606:
        global.msg[0] = "* (This CD is labelled&  " + '"' + "Spooktunes." + '"' + ")/"
    ...
    case 607:
        ...
        break
    case 608:
        global.msg[0] = "* (This CD is labelled&  " + '"' + "Spookwave." + '"' + ")/"
        global.msg[1] = "* (Play it?)& &         Play it     No\C"
        global.msg[2] = " "
        if (global.flag[94] == 2)
        {
    ...
    case 609:
        ...
        break
    case 610:
        global.msg[0] = "* (This CD is labelled&  " + '"' + "Ghouliday Music." + '"' + ")/"
        global.msg[1] = "* (Play it?)& &         Play it     No\C"
        global.msg[2] = " "
        if (global.flag[94] == 3)
        {
    ...
    case 623:
        ...
        global.msg[8] = "* Undyne told me^1, um^1, " + '"' + "stay&  away from that human." + '"' + "/"
    ...
    case 636:
        ...
        global.msg[2] = "* We call this state&  " + '"' + "Fallen Down." + '"' + "/"
    ...
    case 642:
        ...
        global.msg[1] = "* A certain type of monster^1,&  the " + '"' + "boss" + '"' + " monster./"
    ...
    case 704:
        if (global.choice == 0)
        {
            ...
            global.msg[7] = "\M1* We're going to&  become " + '"' + "friends." + '"' + "/"
    ...
    case 720:
        ...
        global.msg[2] = "\M4* " + '"' + "A DOG EXISTS SOMEWHERE." + '"' + "/"
    ...
    case 736:
        ...
        global.msg[2] = "\M5* WHAT COULD BE INSIDE^1?&* WELL^1, NO TIME LIKE THE&  " + '"' + "PRESENT" + '"' + " TO FIND OUT!/"
        global.msg[3] = "\M2* (REPORT THIS ONE?)& &         Report      Look More\C"
        global.msg[4] = " "
        break
    case 737:
    ...
    case 757:
        ...
        break
    case 758:
        global.msg[0] = "* \YMETTATON has sent you an&  invitation to " + '"' + "Die." + '"' + "\W /"
    ...
    case 803:
        ...
        global.msg[6] = "\E3* I'll stop being&  " + '"' + "myself." + '"' + "/"
    ...
    case 810:
        ...
        global.msg[3] = "\E0* " + '"' + "Would you like a&  cup of tea?" + '"' + "/"
        global.msg[4] = "\E2* .../"
    ...
    case 814:
        ...
        scr_sansface(13, 1)
        global.msg[14] = "\E1* we call that&  " + '"' + "the sun^1," + '"' + " my friend./"
        scr_papface(15, 0)
    ...
    case 828:
        if (global.choice == 0)
        {
            ...
            global.msg[13] = "* If you want to know&  " + '"' + "the truth." + '"' + "/"
    ...
    case 854:
        if (global.choice == 0)
        {
            ...
            global.msg[2] = "* (Seems like the dog needs&  to " + '"' + "patch" + '"' + " the fabric.)/"
    ...
    case 860:
        ...
        if (global.flag[262] == 0)
        {
            ...
            global.msg[1] = "* Got my " + '"' + "Sea Tea" + '"' + " ?& &         Yes         No\C"
            global.msg[2] = " "
            if (global.flag[7] == 1)
    ...
    case 862:
        ...
        {
            global.msg[0] = "* Oooooaaah ^1!&* Room service !/"
            global.msg[1] = "* Got my " + '"' + "Cinnamon Bun" + '"' + " ?& &         Yes         No\C"
            global.msg[2] = " "
            if (global.flag[7] == 1)
                global.msg[0] = "* Room service never came ^1.&* (Sigh ...)/%%"
        }
